(function () {
  ...
  if (!document.getElementById(codefundStylesheetId)) {
    ...
    stylesheet.setAttribute('href', 'https://codefund.io/packs/css/code_fund_ad-84aeb682.css')
  ...
  if (document.getElementById(codefundScriptId)) {
    ...
    script.setAttribute('src', 'https://codefund.io/packs/js/code_fund_ad-798219b48ebe932faeed.js')
